#ifndef LT2_RENDER_BUFFER_H
#define LT2_RENDER_BUFFER_H
...
class HdLighthouse2RenderBuffer : public HdRenderBuffer
{
public:
    HdLighthouse2RenderBuffer(SdfPath const& id);
    ~HdLighthouse2RenderBuffer() override;
